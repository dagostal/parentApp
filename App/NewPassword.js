...
export default class NewPassword extends Component {
  ...
  render() {
    return (
      ...
      <View style={{flex:1,justifyContent:'center',alignItems:'flex-start'}}><Image style={{height:height(15),width:width(35)}} source={require("./Busright.png")}></Image></View></View>
      <View style={{flex:3,justifyContent:'center',alignItems:'center'}}>
      <Image style={{height:height(20),width:width(39)}} source={require("./stash.png")}></Image>
      </View>
      <View style={{marginTop:height(2),flex:1,justifyContent:'center',alignItems:'center'}}>
