...
export default class Map1Child extends Component {
      ...
      return (
        ...
        <View style={{height:height(10),flexDirection:'row',backgroundColor:'rgb(247,247,247)'}}>
          ...
          <View style={{borderColor:'#E1E1E1',borderWidth:1,height:height(12),flexDirection:'row',backgroundColor:'white',marginLeft:width(5),marginRight:width(5)}}>
              <View style={{flex:1,justifyContent:'center',alignItems:'center'}}>{this.props.child1absence?<TouchableOpacity onPress={this.markPresent.bind(this,this.props.child1name)}><Image style={{height:50,width:50}} source={require("./RedBox.png")}></Image></TouchableOpacity>:
