...
export default class Map4Child extends Component {
    ...
    render() {
      return (
        ...
        <View style={{height:height(10),flexDirection:'row',backgroundColor:'rgb(247,247,247)'}}>
          ...
          <View style={{borderColor:'#E1E1E1',borderWidth:1,height:height(12),flexDirection:'row',backgroundColor:'white',marginLeft:width(5),marginRight:width(5)}}>
              <View style={{flex:1,justifyContent:'center',alignItems:'center'}}>{this.props.child3absence?<TouchableOpacity  onPress={this.markPresent.bind(this,this.props.child3name)}><Image style={{height:height(10),width:width(15)}} source={require("./RedBox.png")}></Image></TouchableOpacity>:
                <TouchableOpacity  onPress={this.markAbsent.bind(this,this.props.child3name)}><Image style={{height:height(10),width:width(15)}} source={require("./GreenBox.png")}></Image></TouchableOpacity>}
              </View>
              <View style={{flex:1,justifyContent:'center',alignItems:'center'}}><Text style={{color:"#4A90E2"}}>{this.props.child3name}</Text></View>
              <View style={{flex:1,justifyContent:'center',alignItems:'center'}}><Text style={{color:"#4A90E2"}}>{this.props.child3status}</Text></View>
          </View>
          <View style={{borderColor:'#E1E1E1',borderWidth:1,height:height(12),flexDirection:'row',backgroundColor:'white',marginLeft:width(5),marginRight:width(5)}}>
              <View style={{flex:1,justifyContent:'center',alignItems:'center'}}>{this.props.child4absence?<TouchableOpacity  onPress={this.markPresent.bind(this,this.props.child4name)}><Image style={{height:height(10),width:width(15)}} source={require("./RedBox.png")}></Image></TouchableOpacity>:
                <TouchableOpacity  onPress={this.markAbsent.bind(this,this.props.child4name)}><Image style={{height:height(10),width:width(15)}} source={require("./GreenBox.png")}></Image></TouchableOpacity>}
              </View>
              <View style={{flex:1,justifyContent:'center',alignItems:'center'}}><Text style={{color:"#4A90E2"}}>{this.props.child4name}</Text></View>
              <View style={{flex:1,justifyContent:'center',alignItems:'center'}}><Text style={{color:"#4A90E2"}}>{this.props.child4status}</Text></View>
          </View>
        </View>
        )
      }
