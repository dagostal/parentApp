...
export default class PrivacyBefore extends Component {
  ...
  next() {
    if(this.state.accept===false){
      ...
      navigate('NewPassword',{token:this.props.navigation.state.params.token})
}
  ...
  render() {
    return (
            ...
            <View style={{backgroundColor:'white',height:height(10),borderBottomWidth:1,borderBottomColor:'#1CA4FA',marginTop:10}}>
...
<View style={{marginTop:20,marginLeft:5,marginRight:5,marginBottom:5}}><Text style={{color:'#9b9b9b'}}>By indicating during registration that you have read and agreed to the Terms of Use, you are agreeing that you have read and understand the Terms of Use and agree to all of the terms of the Terms of Use. Thank you for your subscription, we are excited to welcome you to the BusWays family!
              ...
              <View style={{borderWidth:1,borderTopColor:'#1CA4FA',height:height(20),width:width(100)}}>
                <View style={{flex:1,flexDirection:'row'}}>
                  <View style={{flex:1,justifyContent:'center',alignItems:'flex-end'}}>{!this.state.accept?<TouchableOpacity onPress={this.accept.bind(this)}><View style={{height:30,width:30,backgroundColor:'white',borderColor:'#00a2fe',borderWidth:1}}></View></TouchableOpacity>:
                          <TouchableOpacity onPress={this.accept.bind(this)}><View style={{height:30,width:30,backgroundColor:'#00a2fe'}}></View></TouchableOpacity>}</View>
                  <View style={{flex:4,justifyContent:'center',alignItems:'center'}}><Text style={{color:'#1CA4FA',fontSize:12}}>I have read and understand the Privacy Policy</Text></View>
                </View>
                <View style={{flex:1,flexDirection:'row'}}>
                  <View style={{flex:1,alignItems:'center'}}>
                  {(!this.state.accept)?(<TouchableOpacity onPress={this.next.bind(this)}><View style={styles.acceptStyle1}>
                  <Text style={{color:'white',fontWeight:'bold'}}>Accept</Text>
                  </View></TouchableOpacity>):(<TouchableOpacity onPress={this.next.bind(this)}><View style={styles.acceptStyle2}>
                  <Text style={{color:'white',fontWeight:'bold'}}>Accept</Text>
                  </View></TouchableOpacity>)}
                  </View>
                  <View style={{flex:1,alignItems:'center'}}><TouchableOpacity onPress={this.decline.bind(this)}><View style={{borderWidth:1,borderColor:'#00a2fe',height:50,width:130,backgroundColor:'white',justifyContent:'center',alignItems:'center'}}>
                  <Text style={{color:'#00a2fe',fontWeight:'bold'}}>Decline</Text>
...
const styles = StyleSheet.create({
  acceptStyle1: {height:50,width:130,backgroundColor:'#00a2fe',justifyContent:'center',alignItems:'center',opacity:.4},
  acceptStyle2: {height:50,width:130,backgroundColor:'#00a2fe',justifyContent:'center',alignItems:'center'}
})
