...
export default class FirstChild extends Component {
  ...
  render() {
    ...
    return (
            <View style={{flex:1}}>
                  <View style={{flex:2,justifyContent:'center',alignItems:'center',marginTop:10}}><Text style={{color:'#8DDA94',fontSize:25,fontWeight:'bold'}}>First Child</Text></View>
                  ...
                  <CodeInput
                    ...
                    autoFocus={false}
                    onFulfill={(isValid, code) => this.setState({done:true,busCode:isValid})}
                  />
                  </View>
                  <View style={{flex:2,flexDirection:'row'}}>
                    <View style={{flex:1}}></View>
                    <View style={{flex:1}}></View>
                    <View style={{flex:1,justifyContent:'center',alignItems:'center',marginBottom:50}}>{this.state.done&&<TouchableOpacity onPress={this.nextChild.bind(this)}><Image style={{height:40,width:40}} source={require("./arrowright.png")}></Image></TouchableOpacity>}</View>
                  </View>
              </View>
    );
  }
